...
import { TrustedDeviceComponent } from 'app/entities/trusted-device/trusted-device.component';
...
describe('Component Tests', () => {
  describe('TrustedDevice Management Component', () => {
    let comp: TrustedDeviceComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [TrustedDeviceComponent],
        providers: [
          {
        ...
        .overrideTemplate(TrustedDeviceComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.trustedDevices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
