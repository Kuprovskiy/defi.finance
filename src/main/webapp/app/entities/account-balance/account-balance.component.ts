...
export class AccountBalanceComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.accountBalanceService
      ...
      .subscribe(
        (res: HttpResponse<IAccountBalance[]>) => this.paginateAccountBalances(res.body, res.headers),
  ...
  protected paginateAccountBalances(data: IAccountBalance[], headers: HttpHeaders) {
